...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar key = exports.key = '0f08cc89fb41537f2d7f8e9420dd9ed2';\n\n//# sourceURL=webpack:///./src/js/config.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Discover = function () {\n    function Discover(genre, sortby) {\n        _classCallCheck(this, Discover);\n\n        this.genre = genre;\n        this.sortby = sortby;\n    }\n\n    _createClass(Discover, [{\n        key: 'getResult',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var results, i, res;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                //1) Array for storing 4 api call data\n                                results = [];\n\n                                //2) Fetching data from api 4 timer to get 80 movies\n\n                                i = 1;\n\n                            case 2:\n                                if (!(i <= 4)) {\n                                    _context.next = 17;\n                                    break;\n                                }\n\n                                _context.prev = 3;\n                                _context.next = 6;\n                                return (0, _axios2.default)('https://api.themoviedb.org/3/discover/movie?api_key=' + _config.key + '&language=en-US&sort_by=' + this.sortby + '.desc&page=' + i);\n\n                            case 6:\n                                res = _context.sent;\n\n\n                                results.push.apply(results, _toConsumableArray(res.data.results)); //Add data to results array\n                                _context.next = 14;\n                                break;\n\n                            case 10:\n                                _context.prev = 10;\n                                _context.t0 = _context['catch'](3);\n\n                                console.log(_context.t0);\n                                alert('Something Wrong In Discover JS (getResult)');\n\n                            case 14:\n                                i++;\n                                _context.next = 2;\n                                break;\n\n                            case 17:\n\n                                //3) Save movies into array\n                                this.result = results;\n\n                            case 18:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[3, 10]]);\n            }));\n\n            function getResult() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getResult;\n        }()\n    }, {\n        key: 'genreName',\n        value: function genreName(genres) {\n            this.result.forEach(function (movie) {\n                if (movie.genre_ids[0]) {\n                    var genre = genres.find(function (el) {\n                        return el.id === movie.genre_ids[0];\n                    });\n                    movie.genre = genre;\n                } else {\n                    movie.genre = { id: 0, name: '' };\n                }\n            });\n        }\n    }, {\n        key: 'filterMovieGenre',\n        value: function filterMovieGenre() {\n            var _this = this;\n\n            //1) Don't fiter if genre is all\n            if (this.genre === 'all') return;\n\n            //2) Fiter if there is a genre\n            var resArr = this.result.filter(function (movie) {\n                return movie.genre.name.toLowerCase() === _this.genre.toLowerCase();\n            });\n\n            //3) Save movies into array\n            this.result = resArr;\n        }\n    }]);\n\n    return Discover;\n}();\n\nexports.default = Discover;\n\n//# sourceURL=webpack:///./src/js/models/Discover.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Trending = function () {\n    function Trending(trend) {\n        _classCallCheck(this, Trending);\n\n        this.trend = trend;\n    }\n\n    _createClass(Trending, [{\n        key: 'getMovies',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var res;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                _context.next = 3;\n                                return (0, _axios2.default)('https://api.themoviedb.org/3/movie/' + this.trend + '?api_key=' + _config.key + '&language=en-US&page=1&&append_to_response=genres');\n\n                            case 3:\n                                res = _context.sent;\n\n\n                                //2) Save movies into array\n                                this.result = res.data.results;\n                                _context.next = 11;\n                                break;\n\n                            case 7:\n                                _context.prev = 7;\n                                _context.t0 = _context['catch'](0);\n\n                                console.log(_context.t0);\n                                alert('Something Wrong In Trending JS (getMovie)');\n\n                            case 11:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 7]]);\n            }));\n\n            function getMovies() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getMovies;\n        }()\n    }, {\n        key: 'getGenres',\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n                var genresRes;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                _context2.prev = 0;\n                                _context2.next = 3;\n                                return (0, _axios2.default)('https://api.themoviedb.org/3/genre/movie/list?api_key=' + _config.key + '&language=en-US');\n\n                            case 3:\n                                genresRes = _context2.sent;\n\n\n                                //2) Save genres into array\n                                this.genres = genresRes.data.genres;\n                                _context2.next = 11;\n                                break;\n\n                            case 7:\n                                _context2.prev = 7;\n                                _context2.t0 = _context2['catch'](0);\n\n                                console.log(_context2.t0);\n                                alert('Something Wrong In Trending JS (getGenres)');\n\n                            case 11:\n                            case 'end':\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this, [[0, 7]]);\n            }));\n\n            function getGenres() {\n                return _ref2.apply(this, arguments);\n            }\n\n            return getGenres;\n        }()\n    }, {\n        key: 'getGenreName',\n        value: function getGenreName() {\n            var _this = this;\n\n            this.result.forEach(function (movie) {\n                var genre = _this.genres.find(function (el) {\n                    return el.id === movie.genre_ids[0];\n                }); //Get genre name by id\n                movie.genre = genre; //Add genre to movie\n            });\n        }\n    }]);\n\n    return Trending;\n}();\n\nexports.default = Trending;\n\n//# sourceURL=webpack:///./src/js/models/Trending.js?");

/***/ }),

/***/ "./src/js/models/favourite.js":
/*!************************************!*\
  !*** ./src/js/models/favourite.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderResult = exports.toggleSelects = exports.clearMovie = exports.getInput = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _discoverView = __webpack_require__(/*! ./discoverView */ \"./src/js/views/discoverView.js\");\n\nvar getInput = exports.getInput = function getInput() {\n    return _base.elements.searchField.value;\n};\n\nvar clearMovie = exports.clearMovie = function clearMovie() {\n    _base.elements.searchResList.innerHTML = '';\n    _base.elements.searchResPages.innerHTML = '';\n};\n\nvar toggleSelects = exports.toggleSelects = function toggleSelects(isSearched) {\n    if (isSearched) {\n        _base.elements.sortbySelect.setAttribute('disabled', 'disabled');\n        _base.elements.genreSelect.setAttribute('disabled', 'disabled');\n        _base.elements.sortbySelect.closest('.select').classList.add('select--disabled');\n        _base.elements.genreSelect.closest('.select').classList.add('select--disabled');\n    } else {\n        _base.elements.sortbySelect.removeAttribute('disabled');\n        _base.elements.genreSelect.removeAttribute('disabled');\n        _base.elements.sortbySelect.closest('.select').classList.remove('select--disabled');\n        _base.elements.genreSelect.closest('.select').classList.remove('select--disabled');\n    }\n};\n\nvar createButton = function createButton(pageActive, page) {\n    return \"\\n    <button class=\\\"btn-inline-search \" + (pageActive === page ? 'btn--active' : '') + \"\\\" data-gotopage=\\\"\" + page + \"\\\">\\n        <span>\" + page + \"</span>\\n    </button>\\n\";\n};\n\nvar renderButton = function renderButton(page, numRes, resPerPage) {\n    //1) Insert button html to the UI\n    var buttons = [];\n\n    //2) Get total page number\n    var pages = Math.ceil(numRes / resPerPage);\n\n    //3) Get button html\n    if (pages > 1) {\n        for (var i = 1; i <= pages; i++) {\n            var button = createButton(page, i);\n            buttons.push(button); //Add button html to buttons\n        }\n    }\n\n    //4) Insert button html to the UI\n    _base.elements.searchResPages.insertAdjacentHTML('afterbegin', buttons.join(''));\n};\n\nvar renderMovie = function renderMovie(movie) {\n    //1) Movie HTML\n    var markup = \"\\n        <li class=\\\"wow fadeIn\\\">\\n            <a class=\\\"search__result__link\\\" href=\\\"#\" + movie.id + \"\\\">\\n                <div class=\\\"search__result__fig\\\">\\n                    <img src=\\\"\" + (movie.poster_path ? \"https://image.tmdb.org/t/p/w500\" + movie.poster_path : './img/unknown.jpg') + \"\\\" alt=\\\"\" + movie.title + \"\\\">\\n\\n                    <div class=\\\"search__result__rating\\\">\\n                        <i class=\\\"material-icons\\\">star</i>\\n                        <p class=\\\"imdb__rating\\\">\" + movie.vote_average.toFixed(1) + \"</p>\\n                    </div>\\n                </div>\\n                <div class=\\\"search__result__data\\\">\\n                    <div class=\\\"search__result__name\\\">\" + movie.title + \"</div>\\n                    <div class=\\\"search__result__genre\\\">\" + movie.genre.name + \"</div>\\n                </div>\\n            </a>\\n        </li>\\n    \";\n\n    //2) Insert markup to the UI\n    _base.elements.searchResList.insertAdjacentHTML('beforeend', markup);\n};\n\nvar renderResult = exports.renderResult = function renderResult(movie) {\n    var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n    var resPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 12;\n\n    //1) Check if there is any movie or not\n    if (movie.length > 0) {\n        //2) Count movies per page\n        var start = (page - 1) * resPerPage;\n        var end = page * resPerPage;\n\n        //3) Render movies\n        movie.slice(start, end).forEach(renderMovie);\n\n        //4) Render pagination buttons\n        renderButton(page, movie.length, resPerPage);\n    } else {\n        //5) If there is no movie display nothing found\n        (0, _discoverView.nothingFound)();\n    }\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");

/***/ }),

/***/ "./src/js/views/trendingView.js":
/*!**************************************!*\
  !*** ./src/js/views/trendingView.js ***!
  \**************************************/
/*! no static exports found */
